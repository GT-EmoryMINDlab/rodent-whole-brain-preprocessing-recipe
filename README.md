...
For mouse brain preprocessing, a raw CSF mask will also be estimated.    
...
#### 1.  Manually edit the brain mask using fsleyes editing tool
    ...
    b. Save the edited brain as "EPI_n4_brain.nii.gz".
    c. (optional for mouse brain): save the edited csf mask as "EPI_n4_csf_mask0_edit.nii.gz"
#### 2. Study-specific EPI template generation (optional): run "GenerateEPItmp.sh"
...
The input is the "EPI_n4_brain.nii.gz" file saved from Step 2. The following 5 procedures will be performed.
