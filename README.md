...
<a name="section-1"></a>
## 1. Dependencies
1. FSL5.0, AFNI and ANTs: A computing server with above 3 software packages installed is perferred. If you don't have a computing server, these can also be installed on a PC (see "SoftwareInstallation_fsl_afni_ants.txt")
