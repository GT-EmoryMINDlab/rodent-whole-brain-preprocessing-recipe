...
If you find this toolbox useful for your work, please cite as: Nan Xu, Leo Zhang, Sam Larson, Zengmin Li, Wen-Ju Pan, Kai-Hsiang Chuang, Shella Keilholz, 2021. Rodent whole-brain fMRI data preprocessing toolbox. https://github.com/GT-EmoryMINDlab/rodent-whole-brain-preprocessing-recipe
...
2. Matlab and and NIfTI and ANALYZE toolbox (https://www.mathworks.com/matlabcentral/fileexchange/8797-tools-for-nifti-and-analyze-image) are needed for calling PCNN3D (which is superior for mouse brain mask creation, see below for details). 
# TODO: git clone, executable permissions, possible file renaming
