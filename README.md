...
#### 2. Motion correction: (motions are corrected to its mean) \_mc
...
#### 3. Distortion correction using fsl topup: \_topup
...
#### 4. Raw brain mask creation: \_n4_bet_mask, \_n4_pcnn3d_mask (\_n4_csf_mask0 for mouse csf mask)
...
#### 1.  Manually edit the brain mask using fsleyes editing tool: \_n4_mask (\_n4_csf_mask)
...
#### 1. EPI registration estimation and wm/csf mask generation: \_n4_brain_reg
...
#### 4. Normalization & temporal filtering: \_mc_topup_norm_fil
...
#### 5. EPI template registration & spatial smoothing: \_mc_topup_norm_fil_reg_sm
