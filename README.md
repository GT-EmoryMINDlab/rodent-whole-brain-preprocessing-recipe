...
You might also need to crop the template files to better fit the coverage of your EPI scans. The matlab function nii_clip.m in the NIfTI toolbox does a good job on this. Two templates are included, the SIGMA_Wistar rat brain template, and a modified Allen Brain Institute Mouse template. The Allen mouse template was modified to better fit the scanning coverage of the mouse datasample. If you have a different scanning coverage in your study, you could create your own study-specifc modified template.
