...
usage() {
  ...
  printf "             [Note]: In addition to the aggregated output file nuisance_design.txt, individual regressors\n"
  printf "                     also have individual output files, e.g. gsEPI.txt, csfEPI.txt, wmcsfEPI.txt, etc.\n"
  ...
  printf "             [Values]\n"
  printf "             Any numerical value (Default: smfwhm=3 (mm), sm_sigma=smfwhm/2.3548)\n\n"
