...
usage() {
  ...
  printf "[Example]\n"
  printf "    ./preproc_script_2.sh --model mouse --fldir data_mouse1 --nuis trends,mot,spca,csf  --tr 1 --smooth 4 --atlas ./lib/tmp/mouseEPIatlas.nii\n\n"
  printf "Options:\n"
  ...
  printf "             [Note:] All specified regressors will be aggregated to the output file nuisance_design.txt. In addition, the specificed brain signals\n"
  printf "                      (i.e., global, WMCSF, or CSF signals) will also be saved into an individual file, i.e., gsEPI.txt, csfEPI.txt, or wmcsfEPI.txt.\n"
  ...
  printf " --add_regr  Name of the file that contains additional nuisance regressor(s) (e.g., task patterns to be regressed) to add to nuisance_design.txt\n\n"
  printf "             [Values]\n"
